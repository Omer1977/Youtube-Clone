...
const VideoCard = ({video, isRow}) => {
  ...
  return (
    <div 
        ...
        onClick={()=>navigate(`/watch?v=${video.videoId}`)} className = {`cursor-pointer ${isRow && 'flex gap-2 items-center'}`}>
        <div>
        <img src={
        ...
        <div className="flex gap-4 mt-5">
            ...
            : '/default.jpg'} className={`w-14 h-14 rounded-full ${isRow && 'hidden'}`}/>
